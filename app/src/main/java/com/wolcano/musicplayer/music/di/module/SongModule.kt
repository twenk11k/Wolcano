...
public class SongModule {
    ...
    public SongModule(SongView view,Fragment fragment,Activity activity,String sort,SongInteractorImpl songInteractor){
        this.view = view;
    ...
    public SongPresenter providePresenter(){
        return new SongPresenterImpl(fragment,activity,sort,songInteractor);
    }
}
