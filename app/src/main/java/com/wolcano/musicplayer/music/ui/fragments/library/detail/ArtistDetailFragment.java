...
public class ArtistDetailFragment extends BaseFragment implements GetDisposable {
    ...
    private void setList(List<Song> alist){
        ...
        mAdapter = new AlbumSongAdapter(getActivity(), alist, ArtistDetailFragment.this);
        controlIfEmpty();
