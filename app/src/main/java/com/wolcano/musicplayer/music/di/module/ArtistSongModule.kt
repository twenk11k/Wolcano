...
public class ArtistSongModule {
    ...
    public ArtistSongModule(SongView view, Fragment fragment, Activity activity, String sort, long artistID, SongInteractorImpl songInteractor) {
        this.view = view;
    ...
    public SongPresenter providePresenter(){
        return new SongPresenterImpl(fragment,activity,sort,artistID,songInteractor);
    }
}
