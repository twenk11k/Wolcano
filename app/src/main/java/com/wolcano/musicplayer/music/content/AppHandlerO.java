...
public class AppHandlerO implements Application.ActivityLifecycleCallbacks {
    ...
    private static AppHandlerO getInstance() {
    ...
    private static class SingletonHolder {
        private static AppHandlerO singletonInstance = new AppHandlerO();
    }
    @Override
    ...
    public void onActivityPaused(final Activity activity) {
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                if (isChecked && remoactCount == 0) {
                    isChecked = false;
                    AppHandlerO.this.notify(activity, false);
                }
            }
        }, HANDLER_VAL);
    }
