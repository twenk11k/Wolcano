...
public class FragmentAlbums extends BaseFragment implements AppBarLayout.OnOffsetChangedListener,AdapterClickListener {
    ...
    private void displayAlbums(List<Album> albumList) {
        ...
        adapter = new AlbumAdapter((MainActivity) getActivity(), albumList,this::getOriginalPosition
        );
        controlIfEmpty();
