...
import com.wolcano.musicplayer.music.content.ScaledImageView;
...
public class SlidingPanel1 implements OnServiceListener,View.OnClickListener {
    ...
    public SlidingPanel1(View view, Activity activity) {
