object Versions {
    ...
    const val APPTHEMEHELPER = "1.3.10"
...
object ThirdPartyLibs {
    ...
    const val MATERIAL_DIALOGS_COMMON = "com.afollestad.material-dialogs:commons:${Versions.MATERIAL_DIALOGS}"
    ...
    const val APPTHEMEHELPER = "com.github.kabouzeid:app-theme-helper:${Versions.APPTHEMEHELPER}"
